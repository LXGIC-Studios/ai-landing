...
![npm](https://img.shields.io/npm/v/ai-landing)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-landing)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Landing page generation and optimization toolkit

Landing page generator. Creates marketing pages with conversion optimization and SEO.
...
[![GitHub stars](https://img.shields.io/github/stars/lxgicstudios/ai-landing)](https://github.com/lxgicstudios/ai-landing/stargazers)
...
```bash
npx ai-landing
# Reads package.json, generates landing.html
